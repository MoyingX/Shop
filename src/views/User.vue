    ...
    <div class="person wrap">
      ...
      <main>
        <aside>
          ...
          <ul class="list">
            <li :class="/\/profiles/g.test($route.path) ? 'active' : ''" @click="$router.push('/user/profiles')">
              个人中心
            </li>
            <li :class="/\/order/g.test($route.path) ? 'active' : ''" @click="$router.push('/user/order')">
              我的订单
            </li>
            <li :class="/\/cart/g.test($route.path) ? 'active' : ''" @click="$router.push('/user/cart')">购物车</li>
